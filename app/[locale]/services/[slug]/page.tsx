...
export function generateStaticParams() { return ["ar", "en"].flatMap(locale => services.map(service => ({ locale, slug: service.slug }))); }
...
export default async function ServicePage({ params }: { params: Promise<{ locale: string; slug: string }> }) {
  ...
  const labels = locale === "ar" ? { eyebrow: "خدمة رقمية تناسب احتياجك", problem: "المشكلة", solution: "الحل المقترح", benefit: "الفائدة العملية", examples: "أمثلة على الاستخدام", features: "خصائص مقترحة", cta: "أخبرنا عن مشروعك", back: "كل الخدمات" } : { eyebrow: "A digital service built around your needs", problem: "The problem", solution: "Proposed solution", benefit: "Practical value", examples: "Use cases", features: "Possible features", cta: "Tell us about your project", back: "All services" };
