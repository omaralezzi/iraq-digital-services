...
export function ProjectWizard({ locale }: { locale: Locale }) {
  ...
  const steps = useMemo(() => [
    ...
    { key: "preferred", label: ar ? "ما وسيلة التواصل المفضلة لديك؟" : "How should we contact you?", hint: ar ? "اختر الوسيلة الأنسب لك" : "Choose the most convenient channel", type: "choices", choices: [ar ? "الهاتف" : "Phone", "WhatsApp", ar ? "البريد الإلكتروني" : "Email"] },
